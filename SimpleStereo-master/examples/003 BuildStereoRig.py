...
loadPath = os.path.join(curPath,"res","4","calib-10")    # Image folder
saveFile = os.path.join(curPath,"res","4","rig.json") # Destination
...
rig = ss.calibration.chessboardStereo( images, chessboardSize=(7,6), squareSize=27.0 )
